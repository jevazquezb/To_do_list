...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_reset_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/reset.css */ \"./src/styles/reset.css\");\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/style.css */ \"./src/styles/style.css\");\n/* harmony import */ var _images_elipsis_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images/elipsis.png */ \"./src/images/elipsis.png\");\n/* harmony import */ var _images_trash_1_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/trash_1.png */ \"./src/images/trash_1.png\");\n/* harmony import */ var _modules_storage_available_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/storage_available.js */ \"./src/modules/storage_available.js\");\n/* harmony import */ var _modules_local_storage_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/local_storage.js */ \"./src/modules/local_storage.js\");\n/* harmony import */ var _modules_task_manager_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/task_manager.js */ \"./src/modules/task_manager.js\");\n/* harmony import */ var _modules_remove_dom_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/remove_dom.js */ \"./src/modules/remove_dom.js\");\n/* harmony import */ var _modules_clear_all_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/clear_all.js */ \"./src/modules/clear_all.js\");\n\n\n\n\n\n\n\n\n\n\nconst form = document.querySelector('form');\nconst input = document.querySelector('#text');\nconst ulist = document.querySelector('ul');\nconst clear = document.querySelector('#clear');\n\nfunction enterTask(e) {\n  e.target.classList.add('uncrossed');\n\n  const tmpIndex = e.target.id.slice(4);\n  const taskItem = document.querySelector(`#main${tmpIndex}`);\n  taskItem.classList.add('task-bg-color');\n\n  const ellipsisBtn = document.querySelector(`#ell${tmpIndex}`);\n  ellipsisBtn.style.display = 'none';\n\n  const trashBtn = document.querySelector(`#trabtn${tmpIndex}`);\n  trashBtn.style.display = 'flex';\n}\n\nfunction exitTask(e) {\n  e.target.classList.remove('uncrossed');\n\n  const tmpIndex = e.target.id.slice(4);\n  const taskItem = document.querySelector(`#main${tmpIndex}`);\n  taskItem.classList.remove('task-bg-color');\n\n  const ellipsisBtn = document.querySelector(`#ell${tmpIndex}`);\n  ellipsisBtn.style.display = 'flex';\n\n  const trashBtn = document.querySelector(`#trabtn${tmpIndex}`);\n  trashBtn.style.display = 'none';\n}\n\nfunction displayTask(task) {\n  const taskItem = document.createElement('li');\n  taskItem.classList.add('disp', 'disp-task', 'btn-border');\n  taskItem.id = `main${task.index}`;\n\n  const checkbox = document.createElement('button');\n  checkbox.classList.add('checkbox');\n  checkbox.title = 'Check!';\n  checkbox.alt = 'Check!';\n  checkbox.type = 'button';\n  checkbox.id = `check${task.index}`;\n  checkbox.addEventListener('click', _modules_clear_all_js__WEBPACK_IMPORTED_MODULE_8__.checkmark);\n  taskItem.appendChild(checkbox);\n\n  const taskMsg = document.createElement('input');\n  taskMsg.classList.add('g-font', 'task');\n  taskMsg.type = 'text';\n  taskMsg.maxLength = '255';\n  taskMsg.id = `desc${task.index}`;\n  taskMsg.value = task.description;\n  taskMsg.addEventListener('focus', enterTask);\n  taskMsg.addEventListener('blur', exitTask);\n  taskMsg.addEventListener('input', _modules_task_manager_js__WEBPACK_IMPORTED_MODULE_6__.editDescription);\n  taskItem.appendChild(taskMsg);\n\n  // Vertical ellipsis button\n  const ellipsisBtn = document.createElement('button');\n  ellipsisBtn.classList.add('img-btn', 'img-task-btn');\n  ellipsisBtn.id = `ell${task.index}`;\n  ellipsisBtn.type = 'button';\n\n  const imgTask = document.createElement('img');\n  imgTask.classList.add('img-size', 'img-task');\n  imgTask.alt = 'Vertical ellipses: Move the task up or down';\n  imgTask.src = _images_elipsis_png__WEBPACK_IMPORTED_MODULE_2__;\n  imgTask.id = `img${task.index}`;\n  ellipsisBtn.appendChild(imgTask);\n  taskItem.appendChild(ellipsisBtn);\n\n  // Trash can button\n  const trashBtn = document.createElement('button');\n  trashBtn.classList.add('img-btn', 'img-trash-btn');\n  trashBtn.id = `trabtn${task.index}`;\n  trashBtn.type = 'button';\n  trashBtn.style.display = 'none';\n\n  const trashImg = document.createElement('img');\n  trashImg.classList.add('trash');\n  trashImg.alt = 'Trash can';\n  trashImg.src = _images_trash_1_png__WEBPACK_IMPORTED_MODULE_3__;\n  trashImg.id = `trash${task.index}`;\n  trashImg.addEventListener('mousedown', (e) => {\n    (0,_modules_task_manager_js__WEBPACK_IMPORTED_MODULE_6__.removeFromStorage)(e);\n    (0,_modules_remove_dom_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])(ulist);\n    const tasksList = (0,_modules_local_storage_js__WEBPACK_IMPORTED_MODULE_5__.getTasks)();\n    tasksList.forEach((task) => {\n      displayTask(task);\n      (0,_modules_clear_all_js__WEBPACK_IMPORTED_MODULE_8__.checkAgain)(task);\n    });\n  });\n  trashBtn.appendChild(trashImg);\n  taskItem.appendChild(trashBtn);\n\n  ulist.appendChild(taskItem);\n}\n\nif ((0,_modules_storage_available_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])('localStorage')) {\n  window.addEventListener('load', () => {\n    const tasksList = (0,_modules_local_storage_js__WEBPACK_IMPORTED_MODULE_5__.getTasks)();\n    tasksList.forEach((task) => {\n      displayTask(task);\n      (0,_modules_clear_all_js__WEBPACK_IMPORTED_MODULE_8__.checkAgain)(task);\n    });\n  });\n  form.addEventListener('submit', (e) => {\n    e.preventDefault();\n    const tasksList = (0,_modules_local_storage_js__WEBPACK_IMPORTED_MODULE_5__.getTasks)();\n    const [newTask, newTasksList] = (0,_modules_task_manager_js__WEBPACK_IMPORTED_MODULE_6__.addTask)(input.value, tasksList);\n    (0,_modules_local_storage_js__WEBPACK_IMPORTED_MODULE_5__.saveTasks)(newTasksList);\n    displayTask(newTask);\n    e.target.reset();\n  });\n  clear.addEventListener('click', () => {\n    (0,_modules_clear_all_js__WEBPACK_IMPORTED_MODULE_8__.clearAll)();\n    (0,_modules_remove_dom_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])(ulist);\n    const tasksList = (0,_modules_local_storage_js__WEBPACK_IMPORTED_MODULE_5__.getTasks)();\n    tasksList.forEach((task) => displayTask(task));\n  });\n}\n\n\n//# sourceURL=webpack://to_do_list/./src/index.js?");
